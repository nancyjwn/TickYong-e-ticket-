...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <!-- Success Message -->
        @if (session('success'))
            <div class="bg-green-100 text-green-800 px-4 py-2 rounded shadow mb-6">
                {{ session('success') }}
            </div>
        @endif
                ...
                <form method="GET" action="{{ route('organizer.events.index') }}">
                    <div class="mb-4">
                        ...
                        <select name="category" id="category"
                            class="w-full px-4 py-2 border border-gray-300 rounded shadow focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="flex justify-end space-x-4">
                        ...
                        <button type="submit"
                            class="bg-blue-600 text-white px-4 py-2 rounded shadow hover:bg-blue-700">Apply</button>
                    </div>
                </form>
            </div>
        </div>
